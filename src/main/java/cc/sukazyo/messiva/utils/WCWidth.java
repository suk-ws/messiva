/*
 * Copyright (c) 2002-2025, the original author(s) from JLine.
 *
 * https://github.com/jline/jline3/blob/c13de76f16eb632b55b23749130627ff1653b693/terminal/src/main/java/org/jline/utils/WCWidth.java
 *
 * With minor modifications by Eyre-S for messiva project.
 *
...
public class WCWidth {
	...
	public static Interval[] combining = {
	...
	public static int wcwidth (String s) {
